...
#here we can change the style image
parser.add_argument("-style_image", help="Style target image", default='examples/inputs/Pop_Art.jpeg')
...
parser.add_argument("-output_image", default='./object_transfered/out.png')

# Other options
parser.add_argument("-style_scale", type=float, default=0.5)
